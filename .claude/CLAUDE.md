...
- **Test-Driven Development (TDD)**: Follow the Red-Green-Refactor cycle strictly
  ...
  - Refactor: Improve code while keeping tests green (maintain behavior)
- Write tests before implementation code - no exceptions
- Maintain high test coverage (>90% for unit tests)
- Each feature must follow complete Red-Green-Refactor cycle
- Commit after each Green and Refactor step for clear development history
...
- `/tasks` - Show current progress and next actionable steps from .tmp/tasks.md
