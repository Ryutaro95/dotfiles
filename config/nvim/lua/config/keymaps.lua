...
keymap("n", "gi", "<CMD>FzfLua lsp_implementations<CR>",  { desc = "LSP: Jump to implementation of interface/abstract method" })
keymap("n", "gt", "<CMD>FzfLua lsp_typedefs<CR>",         { desc = "LSP: Jump to type definition of variable/argument under cursor" })
keymap("n", "gD", "<CMD>FzfLua lsp_declarations<CR>",     { desc = "LSP: Jump to declaration of symbol (may differ from definition)" })
-- Editor
